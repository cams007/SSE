				...
				<div class="form-group">
					...
					<div class="column-3">
						<div class="checkbox">
							...
							<label class="label-radio" for="A"> Comuinicar</label><br>
						...
						<div class="checkbox">
							<input type="checkbox" class="checkbox" name="actitudes" id="M" value="0">
							<label class="label-radio" for="M"> Procesar</label> <br>

							<input type="checkbox" class="checkbox" name="actitudes" id="N" value="0">
							<label class="label-radio" for="N">Expresar</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="O" value="0">
							<label class="label-radio" for="O">Escuchar</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="P" value="0">
							<label class="label-radio" for="P">Resolver conflictos</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="Q" value="0">
							<label class="label-radio" for="Q">Solicitar</label>
						</div>
						<div class="checkbox">
							<input type="checkbox" class="checkbox" name="actitudes" id="R" value="0">
							<label class="label-radio" for="R">Decidir</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="S" value="0">
							<label class="label-radio" for="S">Interpretar</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="T" value="0">
							<label class="label-radio" for="T">Rebatir</label>

							<input type="checkbox" class="checkbox" name="actitudes" id="U" value="0">
							<label class="label-radio" for="U">Innovar</label> <br>

							<input type="checkbox" class="checkbox" name="actitudes" id="otras" value="0">
							<label class="label-radio" for="V">Otras</label>
							<div class="hidden">
				...
				<div class="form-group">
					...
					<div class="column-3">
						<div class="checkbox">
							...
							<label class="label-radio">	Honestidad</label> <br>
							<input type="checkbox" name="valores" id="" value="0">
						...
						<div class="checkbox">
							...
							<input type="checkbox" name="valores" id="" value="0">
							<label class="label-radio"> Solidalidad</label> <br>
							<input type="checkbox" name="valores" id="" value="0">
							<label class="label-radio"> Integridad</label>
							<input type="checkbox" name="valores" id="" value="0">
							<label class="label-radio"> Disciplina</label> <br>
							<input type="checkbox" name="valores" id="" value="0">
						...
						<div class="checkbox">
							...
							<input type="checkbox" name="valores" id="" value="0">
							<label class="label-radio"> Limpieza</label> <br>
						...
						<div class="checkbox">
							...
							<input type="checkbox" name="valores" id="" value="0">
							<label class="label-radio"> Justicia</label> <br>
