...
@section('content')
	<div class="contenedor"><!-- contenedor -->
		...
		<a href="{{url('/admin/historiasdeExito/crearHistoriaDe')}}"><img src="{{ url('assets/images/empresa_estrella_full.png') }}" alt=""></a><!--Button crear historia, acceder por medio de la url-->
		...
		<table> <!--Contenido de la pagina-->
			...
			<tr>
				...
				<td>
					<a href="{{route('admin.editarHistoria', $historia)}}"><img src="{{ url('assets/images/empresa_estrella_full.png') }}" alt=""></a><!--editar--><!--accedemos al name de la ruta-->
